...
export const routes: Routes = [
  {
    ...
    children: [
      {
        path: '', redirectTo: 'dashboard/soffrontdashboard', pathMatch: 'full'
      },
      {
        path: 'dashboard',
      ...
      {
        path: 'defects',
        loadChildren: 'app/+defects/defects.module#DefectsModule',
      ...
      {
        path: 'quicklinks',
        loadChildren: 'app/+quicklinks/quicklinks.module#QuicklinksModule',
        data: {pageTitle: 'Quicklinks'}
      },
      // ,
      // {
      //   path: 'smartadmin',
