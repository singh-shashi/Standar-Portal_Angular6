...
@Component({
  ...
  templateUrl: './requestsawaitingreply.component.html',
  animations: [
    trigger('flyInOut', [
...
export class RequestsaWaitingReplyComponent implements OnInit {
  public apiKey = '';
  public parentObjName = 'Account';
  public parentObjID: number;
  public objectStatus =  'in (\'Waiting Customer Reply\')';
  ...
  onShowDetail(val: boolean) {
    this.showDetail = val;
    if (!val) {
      this.TicketInfoDet = 'Requests Awaiting Reply';
