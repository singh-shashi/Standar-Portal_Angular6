...
@Component({
  ...
  templateUrl: './requestswaitingverification.component.html',
  animations: [
    trigger('flyInOut', [
...
export class RequestsWaitingVerificationComponent implements OnInit {
  public apiKey = '';
  public parentObjName = 'Account';
  public parentObjID: number;
  public objectStatus = 'in (\'Waiting Customer Verification\')';
  ...
  onShowDetail(val: boolean) {
    this.showDetail = val;
    if (!val) {
      this.TicketInfoDet = 'Requests Awaiting Verification';
